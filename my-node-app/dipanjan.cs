// please translate the following COBOL code to C#
// 
...
{
    // Define the Album class to hold album details
    public class Album
    {
    ...
    // Define the MonthTable class to hold month names and counts
    public class MonthTableClass
    {
        public string[] MonthNames = new string[12];
        public int[] MonthCount = new int[12];

        // Constructor to initialize month names
